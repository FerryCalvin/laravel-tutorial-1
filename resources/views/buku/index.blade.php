...
<body>
    <div class="container mt-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action-buttons">
                            <a href="{{ route('buku.edit',['id'=>$item]) }}" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <form action="{{ route('buku.delete', ['id'=>$item->id]) }}" method="post" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-danger text-light" onclick="return confirm('Apakah Anda yakin ingin menghapus buku ini?')">
        ...
        <div class="mt-4 p-3 bg-light rounded">
            <h3>{{ isset($bukuDetail) ? 'Edit Buku' : 'Tambah Buku Baru' }}</h3>
